...
const
  ActionStr: array[TReconcileAction] of string = ('Pular', 'Abortar', 'Unir',
...
var
  UpdateForm: TF_Erros;
begin
  UpdateForm := TF_Erros.CreateForm(DataSet, UpdateKind, ReconcileError);
  with UpdateForm do
  try
...
constructor TF_Erros.CreateForm(DataSet: TDataSet;
...
procedure TF_Erros.InitDataFields;
var
  I: Integer;
  FD: PFieldData;
  V: Variant;
...
procedure TF_Erros.InitUpdateData(HasCurValues: Boolean);
var
  FColCount: Integer;
begin
  FColCount := 1;
...
procedure TF_Erros.InitReconcileActions;
...
procedure TF_Erros.DisplayFieldValues(Sender: TObject);
var
  I: Integer;
  CurRow: Integer;
...
procedure TF_Erros.SetFieldValues(DataSet: TDataSet);
var
  I: Integer;
begin
  for I := 0 to FDataFields.Count - 1 do
...
procedure TF_Erros.AdjustColumnWidths;
var
  NewWidth, I: integer;
begin
  with UpdateData do
...
procedure TF_Erros.FormCreate(Sender: TObject);
begin
...
procedure TF_Erros.FormDestroy(Sender: TObject);
var
  I: Integer;
begin
...
procedure TF_Erros.UpdateDataSetEditText(Sender: TObject; ACol,
...
procedure TF_Erros.UpdateDataSelectCell(Sender: TObject; Col,
